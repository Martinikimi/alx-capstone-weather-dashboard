...
git clone https://github.com/Martinikimi/alx-capstone-weather-dashboard.git
...
// Handles browser geolocation with proper permission management
// Returns coordinates or appropriate error states
useDebounce Hook
